...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_EMPLOYEE = "CREATE TABLE " + DatabaseContract.Employees.TABLE_NAME + " ("
            + DatabaseContract.Employees._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + DatabaseContract.Employees.COL_FIRSTNAME + " TEXT NOT NULL, "
            + DatabaseContract.Employees.COL_SECONDNAME + " TEXT)";
//
